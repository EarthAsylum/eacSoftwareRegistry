 ...
 *
 * uses common code from eacSoftwareRegistry_registration_interface trait
 *
...
trait eacSoftwareRegistry_registration_wordpress
{
	use eacSoftwareRegistry_registration_interface;
	 ...
	 * add_action( 'eacSoftwareRegistry_registry_refresh', array($this, 'refreshRegistration') ); // passes registry_key
